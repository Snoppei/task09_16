...
import vsu.negulyaevPavelNikolaevich.util.JTableUtils;
...
public class FrameMain extends JFrame {
    ...
    public FrameMain() {
        ...
        JTableUtils.initJTableForArray(indexTable, 40, true, false, false, false);
        //tableOutput.setEnabled(false);
        tableInput.setRowHeight(25);
        tableOutput.setRowHeight(25);
        indexTable.setRowHeight(25);
        ...
        JTableUtils.writeArrayToJTable(indexTable, new int[]{ 0, 10});
        ...
        buttonRandomInput.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    int[] arr = ArrayUtils.createRandomIntArray(10, -100, 100);
                    JTableUtils.writeArrayToJTable(tableInput, arr);
                } catch (Exception e) {
                    SwingUtils.showErrorMessageBox(e);
                }
        ...
        buttonCalculate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    int[] arr = JTableUtils.readIntArrayFromJTable(tableInput);
                    List<Integer> list = Logic.arrToList(arr);
                    int[] indexes = JTableUtils.readIntArrayFromJTable(indexTable);
                    int index1 = indexes[0];
                    int index2 = indexes[1];
                    Logic.sort(list, index1, index2);
                    JTableUtils.writeArrayToJTable(tableOutput, Logic.listToArr(list));
                } catch (Exception e) {
                    SwingUtils.showErrorMessageBox(e);
                }
            }
